...
import TestMod.actions.InvincibleAction;
...
public class Invincible extends AbstractDynamicCard {
    ...
    public static final String ID = TestMod.makeID("Invincible"); // DELETE THIS ONE.
    public static final String IMG = makeCardPath("Invincible_Attack.png");// "public static final String IMG = makeCardPath("${NAME}.png");
    ...
    public Invincible() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new InvincibleAction(m, new DamageInfo(p, this.damage, this.damageTypeForTurn)));
    }
