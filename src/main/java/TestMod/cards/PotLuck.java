...
import TestMod.actions.DiscardPileToHandAction;
...
public class PotLuck extends AbstractDynamicCard {

    /*
     * Wiki-page: https://github.com/daviscook477/BaseMod/wiki/Custom-Cards
     *
     * Pot Luck Put 2/3 random Skills from your discard pile into your hand.
     */

    // TEXT DECLARATION

    public static final String ID = TestMod.makeID(PotLuck.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("PotLuck_Skill.png");
    ...
    public PotLuck() {
        ...
        baseMagicNumber = magicNumber = SKILLS;
    }

    // Actions the card should do.
    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new DiscardPileToHandAction(magicNumber, CardType.SKILL));
    }
