...
public class DeadlyTemptation extends AbstractDynamicCard {
    ...
    public static final String ID = TestMod.makeID("DeadlyTemptation"); // DELETE THIS ONE.
    public static final String IMG = makeCardPath("DeadlyTemptation_Skill.png");// "public static final String IMG = makeCardPath("${NAME}.png");
    ...
    public DeadlyTemptation() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
