...
public class MembershipPunch extends AbstractDynamicCard {
     ...
     *
     * Membership Punch Deal 8(10) damage. Gain 5 Membership.
     */
    ...
    public static final String IMG = makeCardPath("MembershipPunch_Attack.png");
    ...
    private static final int MEMBERSHIP = 5;
    ...
    public MembershipPunch() {
        ...
        baseDamage = DAMAGE;
        baseMagicNumber = magicNumber = MEMBERSHIP;
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new MembershipPower(p, magicNumber), magicNumber));
    }
