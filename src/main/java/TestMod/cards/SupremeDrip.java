...
public class SupremeDrip extends AbstractDynamicCard {

    /*
     * Wiki-page: https://github.com/daviscook477/BaseMod/wiki/Custom-Cards
     *
     * Supreme Drip Gain 8 (11) Block. Payment 2: Gain 4 (5) Plated Armor.
     */

    // TEXT DECLARATION

    public static final String ID = TestMod.makeID(SupremeDrip.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("SupremeDrip_Skill.png");
