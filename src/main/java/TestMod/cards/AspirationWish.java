...
import TestMod.actions.AspirationWishAction;
import TestMod.actions.TriggerTalismanAction;
...
public class AspirationWish extends AbstractDynamicCard {

    /*
     * Wiki-page: https://github.com/daviscook477/BaseMod/wiki/Custom-Cards
     *
     * Mockery Deal 8 damage. Deals 3/4 additional damage for every 4 #yMembership.
     */

    // TEXT DECLARATION

    public static final String ID = TestMod.makeID(AspirationWish.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("AspirationWish_Skill.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new AspirationWishAction(this));
    }
