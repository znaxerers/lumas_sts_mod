...
import TestMod.actions.DoubleTalismanAction;
...
public class Moneyshot extends AbstractDynamicCard {

    /*
     * Wiki-page: https://github.com/daviscook477/BaseMod/wiki/Custom-Cards
     *
     * Moneyshot Deal 9 (16) damage and double Talisman.
     */

    // TEXT DECLARATION

    // public static final String ID = DefaultMod.makeID(${NAME}.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String ID = TestMod.makeID("Moneyshot"); // DELETE THIS ONE.
    public static final String IMG = makeCardPath("Moneyshot_Attack.png");// "public static final String IMG = makeCardPath("${NAME}.png");
    ...
    public Moneyshot() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new DoubleTalismanAction(m, p));
    }
