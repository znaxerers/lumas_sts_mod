...
public class Mockery extends AbstractDynamicCard {
    ...
    public static final String ID = TestMod.makeID(Mockery.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Mockery_Attack.png");
    ...
    public void calculateCardDamage(AbstractMonster mo) {
        ...
        if (p.hasPower("TestMod:MembershipPower")) {
            int i = p.getPower("TestMod:MembershipPower").amount / PER_MEMBERSHIP;
            this.damage = this.damage + (this.magicNumber * i);
