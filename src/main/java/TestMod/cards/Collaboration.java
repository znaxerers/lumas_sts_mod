...
public class Collaboration extends AbstractDynamicCard {

    /*
     * Wiki-page: https://github.com/daviscook477/BaseMod/wiki/Custom-Cards
     *
     * Collaboration Deal damage equal to your Membership. NL (Deal !D! damage.)
     */

    // TEXT DECLARATION

    public static final String ID = TestMod.makeID(Collaboration.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Collaboration_Attack.png");
...
//        this.bloodMagic = this.canBloodMagic();
    ...
    public boolean canPayment() {
        AbstractPlayer p = AbstractDungeon.player;
        return p.hasPower("TestMod:MembershipPower");
    }
}