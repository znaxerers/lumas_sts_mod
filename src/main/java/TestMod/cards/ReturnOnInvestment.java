...
public class ReturnOnInvestment extends AbstractDynamicCard {
    ...
    public static final String ID = TestMod.makeID(ReturnOnInvestment.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("ReturnOnInvestment_Attack.png");
    ...
    private static final int MEMBERSHIP_REQUIRED = 10;

    private static final int UPGRADE_PLUS_ADDITIONAL_DMG = 3;
