...
public class TalismanBlade extends AbstractDynamicCard {
    ...
    public static final String ID = TestMod.makeID("TalismanBlade"); // DELETE THIS ONE.
    public static final String IMG = makeCardPath("TalismanBlade_Attack.png");// "public static final String IMG = makeCardPath("${NAME}.png");
    ...
    public TalismanBlade() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
