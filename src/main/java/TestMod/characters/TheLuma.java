...
import static TestMod.characters.TheLuma.Enums.COLOR_GRAY;
public class TheLuma extends CustomPlayer {
    ...
    private static final String ID = makeID("TheLuma");
...
//        e.setTime(e.getEndTime() * MathUtils.random());
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        //retVal.add(ReturnOnInvestment.ID);
...
//        UnlockTracker.markRelicAsSeen(DefaultClickableRelic.ID);
    ...
    public AbstractPlayer newInstance() {
        return new TheLuma(name, chosenClass);
    }
