...
public class Lumo1 extends AbstractMonster {
    public static final String ID = TestMod.makeID(Lumo1.class.getSimpleName());
...
//        e.setTime(e.getEndTime() * MathUtils.random());
    ...
    public void spawn() {
        ...
        this.showHealthBar();
        this.createIntent();
        GenericHelper.MoveMonster(this, AbstractDungeon.player.drawX + 0.0F * Settings.scale, AbstractDungeon.player.drawY + 0.0F * Settings.scale);
    }
    ...
    public int calculateDmg(AbstractMonster mo) {
        ...
        DamageType type = ((DamageInfo)this.damage.get(0)).type;
...
//            }
            ...
            DamageType type = this.meltdownNextTurn ? DamageType.HP_LOSS : DamageType.NORMAL;
            ((DamageInfo)this.damage.get(0)).type = type;
            AttackEffect effect = this.meltdownNextTurn ? AttackEffect.FIRE : (((DamageInfo)this.damage.get(0)).output > 20 ? AttackEffect.SLASH_HORIZONTAL : AttackEffect.SLASH_HEAVY);
            int i;
...
//        }
        ...
        //reflection hacks returns null, i dont fucking know why
